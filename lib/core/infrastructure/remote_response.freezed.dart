...
class _$RemoteResponseTearOff {
  ...
  _WithData<T> withData<T>(T data, {required int maxPage}) {
    return _WithData<T>(
      data,
      maxPage: maxPage,
    );
...
mixin _$RemoteResponse<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T data, int maxPage) withData,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(T data, int maxPage)? withData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_WithData<T> extends _WithData<T> {
  const _$_WithData(this.data, {required this.maxPage}) : super._();
  ...
  @override
  String toString() {
    return 'RemoteResponse<$T>.withData(data: $data, maxPage: $maxPage)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return withData?.call(data, maxPage);
  }
...
abstract class _WithData<T> extends RemoteResponse<T> {
  const factory _WithData(T data, {required int maxPage}) = _$_WithData<T>;
